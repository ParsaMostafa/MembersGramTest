...
class bottom_sheet_layout(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        lineview2.measure(
            MeasureSpec.makeMeasureSpec(lineViewWidth2, MeasureSpec.EXACTLY),
            MeasureSpec.makeMeasureSpec(lineViewHeight2, MeasureSpec.EXACTLY)
        )
