...
//import com.example.membersgramtest.models.paymentchips.RVChips
...
//
//class AdaptorPaymentChips   ( val onClick: (RVChips.RV1ChipsData) -> Unit ) :
//    ListAdapter<RVChips.RV1ChipsData, AdaptorPaymentChips.ChipsItemsViewHolder>(Rv1memDiffCallback()){
//    private var previousSelectedItem : RVChips.RV1ChipsData? = null
//
...
//            val defaultSelectedItem = currentList.find { it == "all" }
//            defaultSelectedItem?.isSelected = true
//            previousSelectedItem = defaultSelectedItem

//        }

//        fun bindChips ( rv1Model: RVChips.RV1ChipsData ) {
//            Log.d("CyberWolf", "Binding item: ${rv1Model.toString()}")
...
//        return ChipsItemsViewHolder(bodyItemRv1)
//    }
//
